...
class Weixinm extends Controller
{
    ...
    {     
         $appid = "wxa4ce17ea47a3aaee";
        $appsecret = "a2f93c9d8aae756673b06bfbfbbfbb39"; 
        $code = $_GET["code"];
         //dump($code);exit;
    ...
    public function qianduanweixinlogin()
      { 
         $appid = "wxa4ce17ea47a3aaee";
       //回调地址
        $redirect_uri = urlencode("http://zhuanqian.dezhouyilian.com/public/index.php/xueyuan/weixinm/weixinqianduan");
        //移动登录测试
